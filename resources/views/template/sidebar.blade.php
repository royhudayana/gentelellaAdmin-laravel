...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      <li><a><i class="fa fa-edit"></i>Submissions </a>
      </li>
      <li><a><i class="fa fa-file-text-o"></i>Issues <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('template_pages.fixed_sidebar') }}">Future Issues</a></li>
          <li><a href="{{ route('template_pages.fixed_footer') }}">Back Issues</a></li>
        </ul>
      </li>
      <li><a><i class="fa fa-gear"></i>Journal Settings </a>
      </li>
      <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('template_pages.index') }}">Dashboard</a></li>
          <li><a href="{{ route('template_pages.index2') }}">Dashboard2</a></li>
          <li><a href="{{ route('template_pages.index3') }}">Dashboard3</a></li>
        </ul>
      </li>
      ...
      <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('template_pages.tables') }}">Tables</a></li>
          <li><a href="{{ route('template_pages.tables_dynamic') }}">Table Dynamic</a></li>
        </ul>
      </li>
  ...
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('template_pages.e_commerce') }}">E-commerce</a></li>
          <li><a href="{{ route('template_pages.projects') }}">Projects</a></li>
          <li><a href="{{ route('template_pages.project_detail') }}">Project Detail</a></li>
          <li><a href="{{ route('template_pages.contacts') }}">Contacts</a></li>
          <li><a href="{{ route('template_pages.profile') }}">Profile</a></li>
        </ul>
      </li>
      <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a href="{{ route('template_pages.page_403') }}">403 Error</a></li>
          <li><a href="{{ route('template_pages.page_404') }}">404 Error</a></li>
          <li><a href="{{ route('template_pages.page_500') }}">500 Error</a></li>
          <li><a href="{{ route('template_pages.plain_page') }}">Plain Page</a></li>
          <li><a href="{{ route('template_pages.login') }}">Login Page</a></li>
          <li><a href="{{ route('template_pages.pricing_tables') }}">Pricing Tables</a></li>
        </ul>
      </li>
      <li><a><i class="fa fa-sitemap"></i> Multilevel Menu <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
            <li><a href="#level1">Level One</a>
